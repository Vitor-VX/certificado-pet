...
<svelte:head>
  <title>Certificado do Pet – Presente Personalizado Digital</title>
  <meta
    name="description"
    content="Celebre seu melhor amigo com um Certificado do Pet personalizado. Um presente simbólico para eternizar o amor, a amizade e os momentos especiais ao lado do seu companheiro."
  />
